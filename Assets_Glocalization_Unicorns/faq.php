					...
					<ul class="accordion-box_two">
						...
						<li class="accordion block active-block">
							<div class="acc-btn active">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>How are the funds selected?
							</div>
							<div class="acc-content current">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
								</div>
							</div>
						</li>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>Can funds be added to my plan?
							</div>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>Where can I get help deciding what funds to choose?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>What is the minimum investment balance?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>How do I set up recurring transfers?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>Can I turn off recurring transfers?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>What should I start investing in?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
			...
			<div class="faq-three_column col-lg-6 col-md-12 col-sm-12">
				...
				<div class="faq-three_column-inner">
					...
					<ul class="accordion-box_two">
						...
						<li class="accordion block active-block">
							<div class="acc-btn active">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>What is diversification?
							</div>
							<div class="acc-content current">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>How much money do I need to start investing in Singapore?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
						...
						<li class="accordion block">
							<div class="acc-btn">
								<div class="icon-outer"><span class="icon fa-solid fa-angle-down fa-fw"></span></div>How do we choose which startups to fund?
							</div>
							<div class="acc-content">
								<div class="content">
									<p>Lorem Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem It is a established fact that a reader will be distracted by the readable content of a page when looking at its layout. </p>
